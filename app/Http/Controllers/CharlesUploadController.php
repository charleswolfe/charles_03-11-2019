...
class CharlesUploadController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $mime_type = $request->file('file')->guessExtension() ?: 'na';
    ...
    public function replace(Request $request, $id)
    {
        ...
        if ($request->file('file')->move($path, $filename)) {
            $charles_file->mime_type = $mime_type;
    ...
    public function download($id)
    {
        ...
        $output_name = $charles_file->label_file_name;
        $headers = [];
    ...
    public function destroy($id)
    {
        ...
        $filename = $charles_file->storage_path . $charles_file->resource_file_name;
